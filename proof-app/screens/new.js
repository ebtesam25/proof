...
export default class NewIn extends React.Component  {
  state = {
    fontsLoaded: false,
    markers: [{"latlng":{
...
//   }
  ...
  render(){
    ...
    <View style={styles.container}>
      ...
      <Text style={{position:'relative',fontSize:35,marginTop:'10%', marginLeft:'5%', textAlign:'left', color:'#000', fontFamily:'FuturaH'}}>New Incident</Text>
      ...
      <Text style={{position:'absolute',fontSize:20,margin:'auto', textAlign:'center', color:'#FFF', fontFamily:'FuturaH', bottom:'5%', backgroundColor:'#000', padding:'5%', width:'70%', borderRadius:10, alignSelf:'center', elevation:1}} onPress={()=>{this.props.navigation.navigate('Login');}}>SUBMIT</Text>
